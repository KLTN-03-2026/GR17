...
class DiaDiemSeeder extends Seeder
{
    public function run(): void
    {
        $data = [
            ...
            // Lưu trú (loại 2)
            $this->location('HUE_KS_001', 'Saigon Morin Hotel Huế', 2, '30 Lê Lợi, Phú Hội, TP Huế', '02343823526', 107.5878, 16.4682, '00:00', '23:59', 1200000, 'https://th.bing.com/th/id/OIP.u89TgHXcSVN3cp56_Bxn7QHaFc?w=262&h=193&c=7&r=0&o=7&dpr=1.3&pid=1.7&rm=3', 'Khách sạn cổ kính view sông Hương, mang đậm dấu ấn kiến trúc Pháp.', 'Lưu trú'),
            $this->location('HUE_KS_002', 'Century Riverside Hotel', 2, '49 Lê Lợi, Phú Hội, TP Huế', '02343823390', 107.5912, 16.4695, '00:00', '23:59', 900000, 'https://th.bing.com/th/id/OIP.qGAOuJURsgI9Yq2iFjAU_gHaF7?w=308&h=195&c=7&r=0&o=7&dpr=1.3&pid=1.7&rm=3', 'Khách sạn lý tưởng để ngắm trọn vẹn cầu Tràng Tiền lộng lẫy về đêm.', 'Lưu trú'),
            // Ẩm thực (loại 3)
            $this->location('HUE_NA_001', 'Bún Bò Huế Bà Gái', 3, '11A Hà Nội, Vĩnh Ninh, TP Huế', '0905111222', 107.5835, 16.4665, '06:00', '21:00', 50000, 'https://th.bing.com/th/id/OIP.l1jairgvPZ45y9TmOzmjgAHaFi?w=232&h=180&c=7&r=0&o=7&dpr=1.3&pid=1.7&rm=3', 'Quán bún bò gia truyền với hương vị ruốc sả đậm đà.', '1 giờ'),
            $this->location('HUE_NA_002', 'Cơm Niêu Khải Hoàn', 3, '90 Lê Lợi, Phú Hội, TP Huế', '02343826968', 107.5955, 16.4710, '09:00', '22:00', 150000, 'https://th.bing.com/th/id/OIP.32Q9cbS4UoPMyj51FQszcAHaFj?w=254&h=191&c=7&r=0&o=7&dpr=1.3&pid=1.7&rm=3', 'Nhà hàng chuyên phục vụ cơm niêu và các món ăn truyền thống cung đình Huế.', '1.5 giờ'),

            // ================= HỘI AN =================
            // Tham quan (loại 1)
            $this->location('HA_TQ_001', 'Phố cổ Hội An', 1, 'Minh An, Hội An, Quảng Nam', '02353111222', 108.3260, 15.8801, '08:00', '22:00', 120000, 'https://th.bing.com/th/id/OIP.1zq4a7G007iHUBybiLxrTwHaEn?w=243&h=180&c=7&r=0&o=7&dpr=1.3&pid=1.7&rm=3', 'Di sản văn hóa thế giới, rực rỡ dưới ánh đèn lồng vào ban đêm.', '3 giờ'),
            $this->location('HA_TQ_002', 'Rừng dừa Bảy Mẫu', 1, 'Cẩm Thanh, Hội An, Quảng Nam', '02353111333', 108.3683, 15.8753, '07:00', '17:30', 150000, 'https://th.bing.com/th/id/OIP.uV32n495BdFiJBcdtj8dlQHaDt?w=337&h=174&c=7&r=0&o=7&dpr=1.3&pid=1.7&rm=3', 'Miền Tây thu nhỏ giữa lòng Hội An, trải nghiệm đi thuyền thúng mộc mạc.', '2 giờ'),
            $this->location('HA_TQ_003', 'Đảo Cù Lao Chàm', 1, 'Tân Hiệp, Hội An, Quảng Nam', '02353111444', 108.5167, 15.9167, '08:00', '16:00', 450000, 'https://th.bing.com/th/id/OIP.tV0sbImkwzZ_QGqmkjqJdQHaE7?w=326&h=180&c=7&r=0&o=7&dpr=1.3&pid=1.7&rm=3', 'Khu dự trữ sinh quyển lặn ngắm san hô cực kỳ hấp dẫn.', '6 giờ'),
            // Lưu trú (loại 2)
            $this->location('HA_KS_001', 'Hoi An Historic Hotel', 2, '10 Trần Hưng Đạo, Hội An, Quảng Nam', '02353861445', 108.3275, 15.8812, '00:00', '23:59', 1100000, 'https://th.bing.com/th/id/OIP.FppPpL2zK5nZDBuxOoW7pQHaE8?w=279&h=185&c=7&r=0&o=7&dpr=1.3&pid=1.7&rm=3', 'Khách sạn lịch sử với không gian sân vườn rộng lớn ngay sát phố cổ.', 'Lưu trú'),
            $this->location('HA_KS_002', 'Mường Thanh Holiday Hội An', 2, 'Khu Ô 9, KĐT Phước Trạch, Hội An', '02353666999', 108.3615, 15.8900, '00:00', '23:59', 1300000, 'https://th.bing.com/th/id/OIP.KiJ_ACii3Hnn12sblz3nFgHaEo?w=237&h=180&c=7&r=0&o=7&dpr=1.3&pid=1.7&rm=3', 'Khách sạn hiện đại nằm gần bãi biển Cửa Đại thanh bình.', 'Lưu trú'),
            // Ẩm thực (loại 3)
            $this->location('HA_NA_001', 'Nhà hàng Bông Hồng Trắng', 3, '533 Hai Bà Trưng, Hội An, Quảng Nam', '02353862784', 108.3268, 15.8835, '07:30', '20:30', 80000, 'https://th.bing.com/th/id/OIP.a6UmnOkzkkMv02a08nBFXwHaFj?w=189&h=180&c=7&r=0&o=7&dpr=1.3&pid=1.7&rm=3', 'Nổi tiếng với món bánh bao bánh vạc (White Rose) độc quyền của dòng họ.', '1 giờ'),
            $this->location('HA_NA_002', 'Cơm Gà Bà Buội', 3, '22 Phan Chu Trinh, Hội An, Quảng Nam', '0905123456', 108.3281, 15.8794, '10:30', '20:00', 45000, 'https://th.bing.com/th/id/OIP.uJyxFVqTfdgaLlcv1C54YwHaFF?w=238&h=180&c=7&r=0&o=7&dpr=1.3&pid=1.7&rm=3', 'Quán cơm gà lâu đời nhất nhì Hội An với thịt gà tơ vàng ươm.', '1 giờ'),
        ];
