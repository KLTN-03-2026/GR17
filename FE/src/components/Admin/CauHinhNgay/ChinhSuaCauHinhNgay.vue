    ...
    async luuCauHinh() {
      ...
      try {
        ...
        await showAlert({
          ...
          message: "Cấu hình ngày đã được cập nhật.",
          tone: "success",
          confirmText: "Đã hiểu",
        });
      } catch (error) {
        ...
        await showAlert({
          title: "Không thể cập nhật cấu hình",
    ...
    async xoaCauHinh() {
      ...
      try {
        ...
        await showAlert({
          ...
          message: `Đã xóa cấu hình ngày CHN ${this.configId}.`,
          tone: "success",
          confirmText: "Đã hiểu",
        });
        ...
        await showAlert({
          title: "Không thể xóa cấu hình",
          message: error.message || "Không thể xóa cấu hình ngày.",
          tone: "danger",
        });
      } finally {
