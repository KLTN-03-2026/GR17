...
const ADMIN_MENU_ITEMS = [
  ...
  { id: "admin-phan-hoi", label: "Quản lý báo lỗi", icon: "fas fa-bug", to: "/admin/phan-hoi", prefixes: ["/admin/phan-hoi"] },
  { id: "admin-voucher", label: "Mã giảm giá", icon: "fas fa-ticket-alt", to: "/admin/voucher", prefixes: ["/admin/voucher"] },
];
