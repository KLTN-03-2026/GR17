  ...
  methods: {
    ...
    async taiTatCaDuLieu() {
      ...
      try {
        ...
        await showAlert({
          ...
          message: this.dinhDangThongBaoLoi(error, "Không thể tải dữ liệu chức vụ, chức năng và phân quyền."),
          tone: "danger",
        });
      } finally {
        this.dangTai = false;
    ...
    async luuChucVu() {
      ...
      try {
        if (this.formChucVu.ma_chuc_vu) {
          ...
          await showAlert({ title: "Đã cập nhật chức vụ", message: response?.data?.message || "Thông tin chức vụ đã được cập nhật.", tone: "success" });
        } else {
          ...
          await showAlert({ title: "Đã tạo chức vụ", message: response?.data?.message || "Chức vụ mới đã được tạo thành công.", tone: "success" });
        }
        this.hienThiModalChucVu = false;
        await this.taiTatCaDuLieu();
      } catch (error) {
        await showAlert({ title: "Lưu chức vụ thất bại", message: this.dinhDangThongBaoLoi(error, "Không thể lưu thông tin chức vụ."), tone: "danger" });
      } finally {
    ...
    async chuyenTrangThaiChucVu(role) {
      ...
      try {
        ...
        await this.taiTatCaDuLieu();
        await showAlert({ title: "Cập nhật trạng thái thành công", message: response?.data?.message || "Trạng thái chức vụ đã được cập nhật.", tone: "success" });
      } catch (error) {
        await showAlert({ title: "Không thể cập nhật trạng thái", message: this.dinhDangThongBaoLoi(error, "Đã xảy ra lỗi khi thay đổi trạng thái chức vụ."), tone: "danger" });
      } finally {
    ...
    async xoaChucVu(role) {
      ...
      try {
        ...
        await this.taiTatCaDuLieu();
        await showAlert({ title: "Đã xóa chức vụ", message: response?.data?.message || "Chức vụ đã được xóa thành công.", tone: "success" });
      } catch (error) {
        await showAlert({ title: "Xóa chức vụ thất bại", message: this.dinhDangThongBaoLoi(error, "Không thể xóa chức vụ này."), tone: "danger" });
      } finally {
        this.xoaChucVuDangXuLy(role.ma_chuc_vu);
      }
    },
    ...
    async luuChucNang() {
      ...
      try {
        if (this.formChucNang.ma_chuc_nang) {
          ...
          await showAlert({ title: "Đã cập nhật chức năng", message: response?.data?.message || "Thông tin chức năng đã được cập nhật.", tone: "success" });
        } else {
          const response = await goiDuLieu(`${API_BASE}/chuc-nang`, { method: "POST", body: payload });
          await showAlert({ title: "Đã tạo chức năng", message: response?.data?.message || "Chức năng mới đã được tạo thành công.", tone: "success" });
        }
        this.hienThiModalChucNang = false;
        await this.taiTatCaDuLieu();
      } catch (error) {
        await showAlert({ title: "Lưu chức năng thất bại", message: this.dinhDangThongBaoLoi(error, "Không thể lưu thông tin chức năng."), tone: "danger" });
      } finally {
    ...
    async xoaChucNang(func) {
      ...
      try {
        ...
        await this.taiTatCaDuLieu();
        await showAlert({ title: "Đã xóa chức năng", message: response?.data?.message || "Chức năng đã được xóa thành công.", tone: "success" });
      } catch (error) {
        await showAlert({ title: "Xóa chức năng thất bại", message: this.dinhDangThongBaoLoi(error, "Không thể xóa chức năng này."), tone: "danger" });
      } finally {
    ...
    async luuPhanQuyen() {
      ...
      if (duplicated) {
        await showAlert({
          title: "Phân quyền bị trùng",
          message: "Liên kết chức vụ và chức năng này đã tồn tại.",
          tone: "warning",
        });
        return;
      }
      ...
      try {
        ...
        await showAlert({
          ...
          message: response?.data?.message || "Phân quyền đã được cập nhật thành công.",
          tone: "success",
        });
      } catch (error) {
        await showAlert({
          title: "Cập nhật phân quyền thất bại",
          message: this.dinhDangThongBaoLoi(error, "Không thể cập nhật phân quyền này."),
          tone: "danger",
        });
      } finally {
    ...
    async xoaPhanQuyen(mapping) {
      ...
      try {
        ...
        await showAlert({
          title: "Đã xóa phân quyền",
          message: response?.data?.message || "Phân quyền đã được xóa thành công.",
          tone: "success",
        });
      } catch (error) {
        await this.taiTatCaDuLieu();
        await showAlert({
          title: "Xóa phân quyền thất bại",
          message: this.dinhDangThongBaoLoi(error, "Không thể xóa phân quyền này."),
          tone: "danger",
        });
      } finally {
    ...
    async chuyenQuyen(roleId, functionId, isChecked, event) {
      ...
      try {
        if (granting && !currentMapping) {
          ...
          await showAlert({ title: "Đã cấp quyền", message: response?.data?.message || "Phân quyền đã được tạo thành công.", tone: "success" });
        }
        if (!granting && currentMapping) {
          ...
          await showAlert({ title: "Đã gỡ quyền", message: response?.data?.message || "Phân quyền đã được xóa thành công.", tone: "success" });
        }
      } catch (error) {
        if (event?.target) event.target.checked = !isChecked;
        await this.taiTatCaDuLieu();
        await showAlert({ title: "Cập nhật phân quyền thất bại", message: this.dinhDangThongBaoLoi(error, "Không thể cập nhật phân quyền cho chức vụ này."), tone: "danger" });
      } finally {
