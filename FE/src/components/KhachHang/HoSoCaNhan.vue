    ...
    async taiHoSo() {
      if (!this.maKhachHang) {
        await showAlert({
          ...
          message: "Không xác định được mã khách hàng trong phiên đăng nhập hiện tại.",
          tone: "danger",
        });
        return;
      }
      ...
      try {
        ...
        await showAlert({
          ...
          message: error?.message || "Không thể tải dữ liệu tài khoản.",
          tone: "danger",
        });
      } finally {
    ...
    async saveProfile() {
      ...
      try {
        ...
        await showAlert({
          ...
          message: duLieuPhanHoi?.message || "Thông tin cá nhân đã được lưu.",
          tone: "success",
        });
      } catch (error) {
        await showAlert({
          title: "Cập nhật thất bại",
          message: error?.message || "Không thể lưu thông tin.",
          tone: "danger",
        });
      } finally {
    ...
    async savePassword() {
      ...
      if (this.passwordForm.new_password !== this.passwordForm.confirm_password) {
        await showAlert({
          ...
          message: "Vui lòng nhập lại đúng mật khẩu mới để tiếp tục.",
          tone: "danger",
        });
        return;
      }
      ...
      try {
        ...
        await showAlert({
          ...
          message: duLieuPhanHoi?.message || "Mật khẩu của bạn đã được cập nhật.",
          tone: "success",
        });
      } catch (error) {
        await showAlert({
