<template>
  <nav class="admin-header">
    <div class="admin-header__left">
      ...
      <h2 class="admin-header__brand-sm">Quản lý đối tác</h2>
    </div>
    ...
    <ul class="admin-header__nav">
      ...
      <li class="admin-header__item">
        ...
        <div class="admin-dropdown admin-dropdown--menu" :class="{ 'is-open': dropdownState.user }">
          ...
          <router-link class="admin-dropdown__menu-item" to="/doi-tac/thong-tin-tai-khoan">
            <i class="far fa-user"></i>
            <span>Thông tin tài khoản</span>
          </router-link>

          <router-link class="admin-dropdown__menu-item" to="/doi-tac/dashboard">
  ...
  methods: {
    ...
    async logout() {
      const isConfirmed = await showConfirm({
        ...
        message: "Bạn có chắc chắn muốn đăng xuất khỏi tài khoản đối tác?",
        tone: "warning"
      });
      if (isConfirmed) {
        this.dropdownState.user = false;
        await authService.logoutPartner();
      }
    },
    clearNotifications() {
