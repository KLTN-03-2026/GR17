    ...
    async duyetTourDoiTac(tour) {
      ...
      try {
        ...
        await showAlert({
          ...
          message: `Tour ${tour.ten} đã được duyệt.`,
          tone: "success",
          confirmText: "Đã hiểu",
        });
      } catch (error) {
        await showAlert({
          title: "Không thể duyệt tour",
          message: this.layThongBaoLoi(error, "Không thể duyệt tour đối tác."),
          tone: "danger",
        });
      } finally {
        this.dangXuLyDuyet = "";
    ...
    async tuChoiTourDoiTac(tour) {
      ...
      try {
        ...
        await showAlert({
          ...
          message: `Tour ${tour.ten} đã được chuyển sang trạng thái chưa duyệt.`,
          tone: "success",
          confirmText: "Đã hiểu",
        });
      } catch (error) {
        await showAlert({
          title: "Không thể cập nhật chưa duyệt",
          message: this.layThongBaoLoi(error, "Không thể từ chối tour đối tác."),
          tone: "danger",
        });
      } finally {
        this.dangXuLyDuyet = "";
