    ...
    async taiChiTietTag(maTag) {
      ...
      try {
        ...
        await showAlert({
          ...
          message: this.layThongBaoLoi(error, "Không thể tải chi tiết tag."),
          tone: "danger",
        });
        return null;
      } finally {
    ...
    async luuTag() {
      ...
      try {
        ...
        if (this.modal.mode === "edit") {
          ...
          await showAlert({
            ...
            message: `Tag "${this.formTag.ten_tag}" đã được cập nhật.`,
            tone: "success",
            confirmText: "Đã hiểu",
          });
        } else {
          ...
          await showAlert({
            title: "Thêm tag thành công",
            message: `Tag "${this.formTag.ten_tag}" đã được tạo.`,
            tone: "success",
            confirmText: "Đã hiểu",
          });
        }
      ...
      try {
        ...
        await showAlert({
          ...
          message: this.layThongBaoLoi(error, "Không thể xóa tag."),
          tone: "danger",
        });
      } finally {
        this.dang_xoa_tag = "";
