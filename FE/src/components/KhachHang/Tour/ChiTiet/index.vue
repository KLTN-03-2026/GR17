          ...
          <div class="detail-grid">
            ...
            <aside class="detail-sidebar">
              <section class="detail-card">
                ...
                <p class="subtitle">Chọn lịch để tham gia Tour</p>
  ...
  methods: {
    ...
    async taiChiTietTour() {
      ...
      try {
        ...
        this.thong_bao_loi = this.layThongBaoLoi(error, "Không thể lấy thông tin tour.");
      } finally {
        this.dang_tai = false;
      }
    },
    chonLich(lich) {
      if (!this.maKhachHang) {
        const confirmResult = confirm("Bạn cần đăng nhập để đặt Tour. Tới trang đăng nhập?");
        if (confirmResult) {
          this.$router.push("/dang-nhap");
        }
        return;
      }
      this.$router.push(`/khach-hang/tour/${this.ma_tour}/thanh-toan`);
    }
  },
};
</script>
